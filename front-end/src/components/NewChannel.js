...
const NewChannel = () => {
  ...
  const onSubmit = async () => {
    ...
    // if public then all users are invited
    if (!checked) {
  ...
  return (
    <div>
      ...
      <Modal open={open}>
        <Box sx={styles.box}>
          <p css={styles.title}>Create a new channel</p>
          <TextField
            id="name"
            name="name"
            label="Channel Name"
          ...
          <FormControlLabel
            ...
            label={<p style={{ color: "white" }}>Public</p>}
          />
          ...
          {checked === true ? (
            ...
            <div>
              <p css={styles.secondTitle}>Add friends to your channel</p>
